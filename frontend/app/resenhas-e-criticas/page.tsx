import { client } from '../../src/sanity' // Confirme se o caminho volta duas pastas para achar o src/sanity
...
// GROQ Query: Busca apenas resenhas e críticas, ordenando da mais nova para a mais velha
